...
export const UI_STRINGS = {
  en: {
    ...
    running: 'Running…',
    runAgain: 'Restart demonstration',
    reset: 'Start over',
    ...
    agentTitle: 'Agnetic AI workflow',
    ...
    showFinalOutput: 'Show Final Output',
    back: 'Back',
    finalDrawerHeaderKicker: 'Final Report · AI-generated & human-approved',
    finalTabReport: 'Full Report',
    finalTabEmail: 'Send via email (simulation)',
    finalTabMis: 'Send to MIS (simulation)',
    finalDrawerHomeHint:
      'Choose an action below to view the approved memorandum, send a simulated email, or register the document in MIS.',
    emailSimSend: 'Send email (simulation)',
    emailSimSent: 'Email sent (simulation)',
    misSimPublish: 'Publish to MIS (simulation)',
    misSimPublishing: 'Publishing to MIS…',
    misSimDone: 'Registered in MIS (simulation)',
    misSimDoneSub: 'This document would appear in the controlled MIS register. No live system was updated.',
    misSimDestination: 'Destination',
    misSimModule: 'Target module',
    misSimDocType: 'Document classification',
    misSimChecksum: 'Integrity check',
    misSimDisclaimer:
      'Simulation only. This mimics registering the final report in the MIS controlled document store. No data leaves this demo.',
  ...
  bn: {
    ...
    running: 'চলছে…',
    runAgain: 'প্রদর্শন পুনরায় শুরু করুন',
    reset: 'আবার শুরু',
    ...
    agentTitle: 'এজেন্টিক AI কাজের ধারা',
    ...
    showFinalOutput: 'শেষ আউটপুট দেখুন',
    back: 'ফিরে যান',
    finalDrawerHeaderKicker: 'চূড়ান্ত প্রতিবেদন · এআই তৈরি ও মানব অনুমোদিত',
    finalTabReport: 'পূর্ণ প্রতিবেদন',
    finalTabEmail: 'ইমেইলে পাঠান (সিমুলেশন)',
    finalTabMis: 'এমআইএস-ে পাঠান (সিমুলেশন)',
    finalDrawerHomeHint:
      'নিচ থেকে নির্বাচন করুন — অনুমোদিত স্মারকপত্র দেখুন, সিমুলেটেড ইমেইল পাঠান, অথবা এমআইএস-ে নথি নিবন্ধন করুন।',
    emailSimSend: 'ইমেইল পাঠান (সিমুলেশন)',
    emailSimSent: 'ইমেইল পাঠানো হয়েছে (সিমুলেশন)',
    misSimPublish: 'এমআইএস-ে প্রকাশ করুন (সিমুলেশন)',
    misSimPublishing: 'এমআইএস-ে প্রকাশ হচ্ছে…',
    misSimDone: 'এমআইএস-ে নিবন্ধিত (সিমুলেশন)',
    misSimDoneSub: 'নথিটি নিয়ন্ত্রিত এমআইএস রেজিস্টারে দেখা যেত। কোনো লাইভ সিস্টেম পরিবর্তন হয়নি।',
    misSimDestination: 'গন্তব্য',
    misSimModule: 'লক্ষ্য মডিউল',
    misSimDocType: 'নথির শ্রেণি',
    misSimChecksum: 'অখণ্ডতা যাচাই',
    misSimDisclaimer:
      'শুধু সিমুলেশন। এটি এমআইএস-এর নিয়ন্ত্রিত নথি সংরক্ষণে চূড়ান্ত রিপোর্ট নিবন্ধনের অনুকরণ। এই ডেমো থেকে কোনো ডেটা বের হয় না।',
